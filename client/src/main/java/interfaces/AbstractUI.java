...
//        requestHandler = new RequestHandler(26262);
        ...
        System.out.println("Enter port: ");
            ...
            try {
                ...
                PORT = 2023;
                System.out.println("Type of PORT was " + userIn.getClass().getSimpleName() + " Intended " + PORT.getClass().getSimpleName());
                logger.error("Type of PORT was " + userIn.getClass().getSimpleName() + " Intended " + PORT.getClass().getSimpleName());
            }
            logger.info("Client port was set to " + PORT);

        requestHandler = new RequestHandler(PORT);
    ...
    private void setDiscNameToInputDataLoop(InputData inputData) throws CancelException {
        while (true) {
            try {
                ...
                logger.warn("Got discipline name.");
//                if (inputData.getDisciplineName() == null | inputData.getDisciplineName().isEmpty() | inputData.getDisciplineName().equals(" ") | inputData.getDisciplineName().trim().equals("") | inputData.getDisciplineName().equals(System.getProperty("line.separator"))) {
//
//                } else {
                    break;
//                }
