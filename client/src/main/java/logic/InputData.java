...
public class InputData implements Serializable {
    ...
    public void setDisciplineName(String disciplineName) throws Exception {
        if (disciplineName.isEmpty() | disciplineName.equals(" ") | disciplineName.trim().equals("") | disciplineName.equals(System.getProperty("line.separator"))) {
            throw new Exception();
        } else
    ...
    public void setSelfStudyHours(String selfStudyHoursString) throws Exception {
        if (selfStudyHoursString.isEmpty() | selfStudyHoursString.equals(" ") | selfStudyHoursString.trim().equals("") | selfStudyHoursString.equals(System.getProperty("line.separator"))) {
            throw new Exception();
        }
        else {
            selfStudyHours = Long.parseLong(selfStudyHoursString);
