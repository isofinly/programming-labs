...
import com.iso.client.views.CommandsMenu;
import com.iso.client.views.ConnectionView;
import com.iso.client.views.LoginView;
import com.iso.client.views.MainView;
...
public class GraphicClient extends Application {
    ...
    public void init() {
        ...
        RadioMenuItem englishMenuItem = new RadioMenuItem("English (Indian)");
        ...
        RadioMenuItem romanianMenuItem = new RadioMenuItem("中國人");
        romanianMenuItem.setOnAction(e -> LocaleManager.setLocale(Locale.forLanguageTag("zh-CN")));

        RadioMenuItem latvianMenuItem = new RadioMenuItem("Polski");
        latvianMenuItem.setOnAction(e -> LocaleManager.setLocale(Locale.forLanguageTag("pl-PL")));

        RadioMenuItem mexicanSpanishMenuItem = new RadioMenuItem("Беларускі");
        mexicanSpanishMenuItem.setOnAction(e -> LocaleManager.setLocale(Locale.forLanguageTag("be-BY")));
